      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.typewriter} text="基石量化 FxKiller" type="typewriter" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.gradient} text="基石量化 FxKiller" type="gradient" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-black dark:bg-gray-950">
            <ModernTextAnimation key={keys.glitch} text="基石量化 FxKiller" type="glitch" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-black dark:bg-gray-950">
            <ModernTextAnimation key={keys.neon} text="基石量化 FxKiller" type="neon" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.scale} text="基石量化 FxKiller" type="scale" />
          </div>
        </div>
        ...
        <div className="mb-32">
          ...
          <div className="min-h-[200px] border-2 border-black dark:border-white rounded-lg flex items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-black">
            <ModernTextAnimation key={keys.split} text="基石量化 FxKiller" type="split" />
          </div>
        </div>
