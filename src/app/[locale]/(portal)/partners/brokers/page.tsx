...
export default function PartnerBrokersPage() {
  ...
  // Partner broker data - real StoneArk partners
  const brokers = [
    {
      id: 'ec-markets',
      name: 'EC Markets',
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-black mb-6 leading-tight">
              {isZh ? 'StoneArk 合作经纪商' : 'StoneArk Partner Brokers'}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              {isZh
                ? 'StoneArk只推荐满足以下所有标准的经纪商，为您的交易安全保驾护航'
                : 'StoneArk only recommends brokers meeting all the following criteria, safeguarding your trading security'}
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              {isZh
                ? '以下经纪商均经过StoneArk团队严格审核，符合我们的所有筛选标准'
                : 'All brokers below have been rigorously vetted by the StoneArk team and meet all our selection criteria'}
            </p>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    {isZh
                      ? 'StoneArk可能从部分推荐链接中获得佣金，但这不影响我们的筛选标准。'
                      : 'StoneArk may receive commission from some referral links, but this does not affect our selection criteria.'}
                  </span>
                </li>
              </ul>
            </div>
