      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            "• 反对或限制我们处理您的数据",
            "• 数据可携带权（获取您的数据副本）",
            "如需行使这些权利，请通过 bigbossa.tzl@gmail.com 联系我们。"
          ]
        },
        {
          title: "7. 第三方服务",
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            ...
            "To exercise these rights, please contact us at bigbossa.tzl@gmail.com"
          ]
        },
        {
