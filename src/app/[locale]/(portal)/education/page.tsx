...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    '外汇交易教育中心 - 系统化学习外汇交易知识 | StoneArk',
    'Forex Trading Education Center - Systematic Learning Path | StoneArk',
    '完整的外汇交易教育体系，涵盖基础知识、技术分析、交易策略、风险管理。从零基础到职业交易员，StoneArk助你系统化学习外汇交易。25+专业课程，4大学习方向，100%免费学习。',
    'Complete forex trading education system covering fundamentals, technical analysis, trading strategies, and risk management. From beginner to professional trader with StoneArk. 25+ professional courses, 4 learning categories, 100% free.',
    ...
    lang,
    {
      ...
      type: 'website',
      section: 'Education',
      author: 'StoneArk Education Team',
    }
  );
}
        ...
        <div className="bg-gray-50 dark:bg-gray-900 border-2 border-black dark:border-white p-12 mb-20">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-black mb-6 text-black dark:text-white">
              {isZh ? '为什么选择 StoneArk 教育中心？' : 'Why Choose StoneArk Education Center?'}
            </h2>
        ...
        <div className="bg-black dark:bg-white text-white dark:text-black p-12 border-2 border-black dark:border-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-300 dark:text-gray-700">
              {isZh ? (
                <>
                  完成教育中心的学习后，加入 StoneArk 30天系统化培训<br />
                  通过考核，获得真实资金进行交易
                </>
              ) : (
                <>
                  After completing the education center, join StoneArk 30-day systematic training<br />
