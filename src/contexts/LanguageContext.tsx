...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'joinus.plan.phase4.1': '小额实盘依旧保持盈利考核要求：不错单，不亏损',
    ...
    'faq.category.course': '关于 StoneArk',
    ...
    'donate.how.step2.desc': '邮件至 bigbossa.tzl@gmail.com，说明您的意向',
    ...
    'dashboard.footer.copyright': '2024-2025 © StoneArk 专业外汇交易员培训平台',
    ...
    'blog.noPosts': '暂无文章',
    'blog.notFound': '文章未找到',
    'blog.backToBlog': '返回社区',
    'blog.relatedPosts': '相关文章',
    'blog.cta.title': '准备开始您的交易之旅？',
    'blog.cta.subtitle': '加入StoneArk，接受专业的交易员培训',
  ...
  en: {
    ...
    'footer.copyright': '© StoneArk · Professional Forex Trader Training Platform · fxkiller.com',
    ...
    'joinus.plan.phase4.1': 'Small-amount live trading maintains profit assessment requirements: correct orders, no losses',
    ...
    'faq.category.course': 'About StoneArk',
    ...
    'donate.how.step2.desc': 'Email to bigbossa.tzl@gmail.com explaining your intention',
    ...
    'dashboard.footer.copyright': '2024-2025 © StoneArk Professional Forex Trader Training Platform',
    ...
    'blog.backToBlog': 'Back to Community',
    'blog.relatedPosts': 'Related Posts',
    'blog.cta.title': 'Ready to Start Your Trading Journey?',
    'blog.cta.subtitle': 'Join StoneArk for professional trader training',
