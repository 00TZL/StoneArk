...
export const spreadsCommissionsContent = {
  zh: {
    title: '外汇点差与佣金完整指南 - 交易成本详解与优化策略 | StoneArk',
    ...
    ctaDescription: 'StoneArk 合作经纪商提供极具竞争力的点差和佣金',
  ...
  en: {
    title: 'Complete Guide to Forex Spreads and Commissions - Trading Costs Explained | StoneArk',
    ...
    ctaDescription: 'StoneArk partner brokers offer highly competitive spreads and commissions',
