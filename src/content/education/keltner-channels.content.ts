...
export const keltnerChannelsContent = {
  zh: {
    title: '肯特纳通道指标完整指南 - Keltner Channels交易策略与实战技巧 | StoneArk',
    ...
    ctaTitle: '想要系统学习技术分析？',
    ctaDescription: '加入 StoneArk 培训计划，掌握更多实战技术指标应用',
  ...
  en: {
    title: 'Complete Keltner Channels Guide - KC Trading Strategies and Practical Techniques | StoneArk',
    ...
    ctaDescription: 'Join StoneArk training to master more practical technical indicator applications',
