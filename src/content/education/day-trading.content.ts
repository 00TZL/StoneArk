...
export const dayTradingContent = {
  zh: {
    title: '日内交易完整指南 - Day Trading策略与风险管理实战技巧 | StoneArk',
    ...
    ctaTitle: '想要系统学习日内交易？',
    ctaDescription: '加入 StoneArk 培训计划，获取专业日内交易策略和实时交易指导',
  ...
  en: {
    title: 'Complete Day Trading Guide - Strategies and Risk Management Techniques | StoneArk',
    ...
    ctaDescription: 'Join StoneArk training for professional day trading strategies and live trading guidance',
