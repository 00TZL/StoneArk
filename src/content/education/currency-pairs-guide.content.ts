...
export const currencyPairsGuideContent = {
  zh: {
    title: '货币对完整解析 - 主要、次要与异国货币对交易指南 | StoneArk',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '公式：点值 = (0.0001 / 当前汇率) × 手数 × 合约单位。EUR/USD交易1标准手（100,000单位），当前价格1.1000，点值 = (0.0001 / 1.1000) × 1 × 100,000 = $9.09。USD/JPY以日元报价，1标准手点值固定约$9.09（汇率145时）。使用StoneArk仓位计算器可自动计算点值和仓位。'
      },
      {
  ...
  en: {
    title: 'Complete Currency Pairs Guide - Major, Minor & Exotic Pairs Trading | StoneArk',
