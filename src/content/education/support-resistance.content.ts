...
export const supportResistanceContent = {
  zh: {
    title: '支撑阻力与趋势线完整指南 - 水平位、动态位与突破交易策略 | StoneArk',
    ...
    ctaTitle: '想要精通支撑阻力交易？',
    ctaDescription: '加入StoneArk培训，学习专业支撑阻力识别与突破交易策略',
  ...
  en: {
    title: 'Support Resistance & Trendlines Guide - Horizontal, Dynamic Levels & Breakout Strategies | StoneArk',
    ...
    ctaDescription: 'Join StoneArk training to learn professional S/R identification and breakout strategies',
