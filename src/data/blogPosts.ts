...
export const blogPosts: BlogPost[] = [
 ...
 title: {
 zh: '关于基石量化 (StoneArk) - 军事化外汇交易员训练营',
 en: 'About StoneArk - Military-Style Forex Trader Training Camp'
 },
 excerpt: {
 zh: '基石量化 (StoneArk) 是一个专注于筛选和培养外汇交易员的训练营。我们的理念：培养真正适合的人，留下极少数，劝返大多数。通过率10%-15%，30个工作日完整培训，盈利分成60%-90%。',
 en: 'StoneArk is a training camp focused on selecting and cultivating forex traders. Our philosophy: cultivating those truly suited, retaining the few, advising the majority. Pass rate 10%-15%, 30 working days complete training, 60%-90% profit share.'
 },
 content: {
 zh: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">关于基石量化 (StoneArk)</h1>

<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">基石量化是一个专注于筛选和培养顶尖外汇交易员的军事化训练营。我们不追求数量，只培养真正适合的人。这是一个严格、高强度、高淘汰率的专业训练项目。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">基石量化采用军事化管理模式，因为我们深知：交易是一场心理战争，需要极强的纪律性、执行力和心理素质。我们的培训不是教你如何快速致富，而是培养你成为一名专业的、可持续盈利的交易员。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">基石量化采用分润制度，你的收入完全取决于你的交易盈利。我们不收取任何培训费用，也不要求你投入自己的资金。公司提供配资，你只需专注于交易。</p>
...
<p class="text-sm text-gray-500 dark:text-gray-500">邮箱：bigbossa.tzl@gmail.com</p>
</div>
</div>
</div>
...
<li class="text-white dark:text-black leading-relaxed flex items-start gap-2"><span class="font-bold">•</span><span>如有虚假信息，一经发现立即淘汰</span></li>
 ...
 en: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">About StoneArk (StoneArk)</h1>

<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">StoneArk is a military-style training camp focused on selecting and cultivating top forex traders. We don't pursue quantity, only cultivating those truly suited. This is a strict, high-intensity, high-elimination professional training program.</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">StoneArk adopts a military-style management model because we know: trading is a psychological war requiring extreme discipline, execution, and mental strength. Our training isn't about teaching you how to get rich quick, but cultivating you to become a professional, sustainable trader.</p>
...
<p class="text-sm text-gray-500 dark:text-gray-500">Email: bigbossa.tzl@gmail.com</p>
</div>
</div>
</div>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">StoneArk is not just a training institution, but more like a highly disciplined military camp. We won't promise you quick riches or easy success. What we can provide is:</p>
...
<p class="text-lg text-center text-white dark:text-black">Email us: bigbossa.tzl@gmail.com</p>
</div>
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">💡 基石量化推荐：波段交易策略</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">某基石量化学员的真实交易记录（已脱敏）</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">StoneArk Recommendation: Swing Trading Strategy</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">Real trading record from an StoneArk student (anonymized)</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
