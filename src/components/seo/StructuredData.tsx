...
export default function StructuredData() {
  ...
  const organizationSchema = {
    ...
    "name": language === 'zh' ? "基石量化 StoneArk" : "StoneArk",
    "alternateName": language === 'zh' ? "StoneArk" : "基石量化",
  ...
  const courseSchema = pathname.includes('/splan/courses') ? {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": language === 'zh' ? "StoneArk 职业交易员培训课程" : "StoneArk Professional Trader Training Course",
    "description": language === 'zh'
